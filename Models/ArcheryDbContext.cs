...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("server=localhost;port=3306;database=archery;user=root;password=Tienhung555016_SQL", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.43-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Arrow>(entity =>
        {
            ...
            entity.HasOne(d => d.End).WithMany(p => p.Arrows)
        ...
        modelBuilder.Entity<End>(entity =>
        {
            ...
            entity.HasOne(d => d.Range).WithMany(p => p.Ends)
                .HasForeignKey(d => d.RangeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("end_ibfk_2");

            entity.HasOne(d => d.Score).WithMany(p => p.Ends)
        ...
        modelBuilder.Entity<Roundrange>(entity =>
        {
            ...
            entity.HasOne(d => d.Range).WithMany(p => p.Roundranges)
                .HasForeignKey(d => d.RangeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("roundrange_ibfk_2");

            entity.HasOne(d => d.Round).WithMany(p => p.Roundranges)
        ...
        modelBuilder.Entity<Score>(entity =>
        {
            ...
            entity.HasOne(d => d.Archer).WithMany(p => p.Scores)
                .HasForeignKey(d => d.ArcherId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("score_ibfk_1");

            entity.HasOne(d => d.Comp).WithMany(p => p.Scores)
