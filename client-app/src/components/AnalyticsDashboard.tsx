...
export function AnalyticsDashboard({ userId }: { userId: string }) {
    ...
    const generateAiAnalysis = async () => {
        ...
        try {
            ...
            // Filter statistics based on dropdown selection
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500">
            ...
            <Card className="shadow-md">
                <CardHeader>
                    <CardTitle>Score Progress (By Round Type)</CardTitle>
                    <CardDescription>Compare performance across different competition/practice formats</CardDescription>
                </CardHeader>
            ...
            <Card className="bg-slate-900 text-white shadow-xl overflow-hidden border-none">
                ...
                <CardHeader className="pb-2 relative z-10">
                    ...
                    <CardDescription className="text-slate-400">
                        The system will automatically create a comparison table if you select "All".
                    </CardDescription>
                </CardHeader>
                    ...
                    <div className="flex flex-col md:flex-row gap-4 items-end">
                        ...
                        <div className="w-full md:w-auto">
                            ...
                            >
                                ...
                                {isDeepAnalysis ? "Mode: Detailed & Technical" : "Mode: Overview"}
                            </Button>
                        </div>
                        ...
                        >
                            {aiLoading ? <><Loader2 className="mr-2 h-4 w-4 animate-spin" /> AI is generating table...</> : 'Analyze Now'}
                        </Button>
                    </div>
                    ...
                    {aiAdvice && (
                        <div className="animate-in fade-in slide-in-from-bottom-2 bg-slate-800/50 p-5 rounded-xl border border-slate-700 mt-4">
                            <div className="flex items-center gap-2 mb-4 text-yellow-400 font-semibold border-b border-slate-700/50 pb-2">
                                <Sparkles className="w-4 h-4" /> Analysis Results from AI Coach:
                            </div>

                            {/* Markdown render area with custom components, TS errors fixed */}
